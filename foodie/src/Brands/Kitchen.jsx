...
export default function Kitchen(){
    ...
    const Kitchen =product.filter((p) => p.brand === "kitchen");

    const indexOfLastProduct = currentPage * productsPerPage;
    const indexOfFirstProduct = indexOfLastProduct - productsPerPage;
    const currentProducts = Kitchen.slice(indexOfFirstProduct, indexOfLastProduct);
    ...
    const totalPages = Math.ceil(Kitchen.length / productsPerPage)
