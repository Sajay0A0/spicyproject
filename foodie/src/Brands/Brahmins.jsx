...
export default function Brahmins(){
    const {product} = useContext(myContext);
    const [currentPage, setCurrentPage] = useState(1);
    const productsPerPage = 16;
    
    const brahmins =product.filter((p) => p.brand === "brahmin");

    const indexOfLastProduct = currentPage * productsPerPage;
    const indexOfFirstProduct = indexOfLastProduct - productsPerPage;
    const currentProducts = brahmins.slice(indexOfFirstProduct, indexOfLastProduct);
    ...
    const totalPages = Math.ceil(brahmins.length / productsPerPage)
    ...
    return(
      ...
      <div className="prod-img">
        ...
        <div className="prod-head">
          ...
          <div className="short-title"> <p > Products </p> </div>
          <h1 className="prod-title">Brahmins</h1>
        </div>
      </div>
