...
export default function Saras(){
    ...
    const saras =product.filter((p) => p.brand === "saras");

    const indexOfLastProduct = currentPage * productsPerPage;
    const indexOfFirstProduct = indexOfLastProduct - productsPerPage;
    const currentProducts = saras.slice(indexOfFirstProduct, indexOfLastProduct);
    ...
    const totalPages = Math.ceil(saras.length / productsPerPage)
